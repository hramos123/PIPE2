...
*/
public interface KeywordSearchServiceAsync {
    /*
   * Submits this text to a search, returns genes.
   ...
   * the category in the resource that it matched the search term.
    */
    void runGOKeywordSearch(String text, String organism, AsyncCallback<ArrayList<Namelist>> async);
    ...
    /*
       ...
       * the category in the resource that it matched the search term.
        */
    void runUniProtKeywordSearch(String text, String organism, AsyncCallback<ArrayList<Namelist>> async);
}
